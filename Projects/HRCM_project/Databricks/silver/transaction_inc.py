...
df_hosa=spark.read.parquet("/mnt/bronze/hosa/transactions.parquet")
df_hosa=df_hosa.withColumn("datasource",lit("hosa"))

#Reading Hospital B departments data 
df_hosb=spark.read.parquet("/mnt/bronze/hosb/transactions.parquet")
df_hosb=df_hosb.withColumn("datasource",lit("hosb"))

#union two departments dataframes
df_merged = df_hosa.unionByName(df_hosb).createOrReplaceTempView("transactions")
