...
#reading patients hosa data

df=spark.read.format("parquet").load("/mnt/bronze/hosa/patients.parquet")
df=df.withColumn("datasource",lit("hosa")).createOrReplaceTempView("patients_hosa")

#reading patients hosb data

df1=spark.read.format("parquet").load("/mnt/bronze/hosb/patients.parquet")
df1=df1.withColumn("datasource",lit("hosb")).createOrReplaceTempView("patients_hosb")
